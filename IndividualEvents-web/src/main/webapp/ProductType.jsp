    ...
    <div class="am-form am-g">
        <div class="tpl-login">
            <div class="tpl-login-content"  style="width: 400px">
                ...
                <s:form class="am-form tpl-form-line-form" method="post" action="typeAction_AddTbType">
                    <s:hidden name="type.tno"/>
                    <div class="am-form-group">
                        输入类型：<s:textfield class="tpl-form-input" name="type.tname"/>
                    </div>
                    <div class="am-form-group">
                        <input type="submit" class="am-btn am-btn-primary am-btn-block tpl-btn-bg-color-success tpl-login-btn" value="确认添加"/>
                    </div>
                </s:form>
                <table class="am-table am-table-bordered am-table-radius am-table-striped">
                    ...
                    <s:iterator value="#request.typeList" var="obj" status="ids">
                        <tr>
                            <td>${ids.count }</td>
                            <td>${obj.tname }</td>
                            <td>
                                <a href="typeAction_deleteTbType?type.tno=${obj.tno }">删除</a>
                            </td>
                        </tr>
                    </s:iterator>
                </table>
