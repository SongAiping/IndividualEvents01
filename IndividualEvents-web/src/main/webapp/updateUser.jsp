        ...
        <div class="tpl-login">
            <div class="tpl-login-content"  style="width: 400px">
                ...
                <s:if test="#parameters.msg[0]==1">
                    <p style="color:green">修改资料成功！</p>
                </s:if>
                <s:elseif test="#parameters.msg[0]==-1">
                    <p style="color:red">修改资料失败！</p>
                </s:elseif>

                <s:form class="am-form tpl-form-line-form" method="post" action="userAction_updateTbUserInfo">

                    <s:hidden name="userInfo.ino"/>
                    <s:hidden name="userInfo.ipwd"/>

                    头像：
                    <img src="${userInfo.iimg }" id='show'>
                    <s:hidden name="userInfo.iimg"/>
                     <s:file id='file'  onchange="c()" name="userImage"/>
                    ...
                    出生年月：
                    <div class="am-form-group">
                        <s:textfield class="tpl-form-input" name="userInfo.ibirthday" />
                    </div

                    <br/>

                    性别：<s:radio name="userInfo.isex" list="{'男','女'}"></s:radio><br/>

                    <div class="am-form-group">
                        邮件： <s:textfield class="tpl-form-input" name="userInfo.iemail"/>
                    </div>

                    <div class="am-form-group">
                        联系电话：<s:textfield class="tpl-form-input" name="userInfo.itab"/>
                    </div>
