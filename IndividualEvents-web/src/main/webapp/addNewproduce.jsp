    ...
    <div class="am-form am-g">
        <div class="tpl-login">
            ...
            <s:if test="#parameters.msg[0]==1">
                <p style="color:green">添加商品成功！</p>
            </s:if>
            <s:elseif test="#parameters.msg[0]==-1">
                <p style="color:red">添加商品失败！</p>
            </s:elseif>

            <form class="am-form tpl-form-line-form" method="post" action="productAction_addProduct" enctype="multipart/form-data"  >

                <img src="" id='show'>
                <s:file id='file' onchange="c()" name="productImage"/>

                <div class="am-form-group">
                    <s:textfield class="tpl-form-input" name="product.pname" placeholder="商品名称"/>
                </div>

                <div class="am-form-group">
                    <s:textfield class="tpl-form-input" name="product.psize" placeholder="尺码"/>
                </div>

                <div class="am-form-group">
                    <s:select name="product.type.tno" list="#request.productList" headerKey="" headerValue="请选择商品类型" listKey="tno" listValue="tname"/><br/>
                </div>


                <div class="am-form-group">
                    <s:textfield class="tpl-form-input" name="product.pprice" placeholder="价格"/>
                </div>

                <div class="am-form-group">
                    <s:radio list="#{ 1 : '上架', 0 : '下架'}" name="product.pstatus"  value="1" />
                </div>

                <div class="am-form-group">
                    <s:textfield class="tpl-form-input" name="product.ppackage" placeholder="是否包邮"/>
                </div>

                <div class="am-form-group">
                    <input type="submit" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn" value="确认添加新商品"/>
                </div>
            </form>

            <a href="productAction_findproductList">查询商品信息</a>
