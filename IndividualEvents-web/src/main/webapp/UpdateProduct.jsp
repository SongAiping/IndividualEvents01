...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
        ...
        <ul>
            ...
            <li><a href="productAction_toUpdateProduct">编辑商品信息</a></li>
        </ul>
    ...
    <div class="am-form am-g">
        <div class="tpl-login">
            <div class="tpl-login-content"  style="width: 400px" >
                ...
                <s:form class="am-form tpl-form-line-form" method="post" action="productAction_UpdateProduct">

                    <s:hidden name="product.pno"/>

                    <img src="${product.pimg }" id='show'>
                    <s:hidden name="product.pimg"/>
                    <s:file id='file'  onchange="c()" name="productImage"/>


                    <div class="am-form-group">
                        商品名称：<s:textfield class="tpl-form-input" name="product.pname"/>
                    </div>

                    <div class="am-form-group">
                        商品大小尺码：<s:textfield class="tpl-form-input" name="product.psize"/>
                    </div>

                    <div class="am-form-group">
                        商品类型： <s:select name="product.type.tno" list="#request.productList" headerKey="" headerValue="请选择商品类型" listKey="tno" listValue="tname"/><br/>
                    </div>


                    <div class="am-form-group">
                        商品价格： <s:textfield class="tpl-form-input" name="product.pprice"/>
                    </div>

                    <div class="am-form-group">
                        是否包邮: <s:textfield class="tpl-form-input" name="product.ppackage"/>
                    </div>


                    <div class="am-form-group">
                        <input type="submit"  value="确认修改" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn"/>
                    </div>
                </s:form>
